...
import { ArrowLeft, CheckCircle, XCircle, AlertTriangle, Clock, Loader2, User, Stethoscope, Package, PackageCheck, CreditCard, Paperclip, Activity } from "lucide-react";
...
import { ExtraPackageTab } from "@/components/tabs/ExtraPackageTab";
import { PendenciesTab } from "@/components/tabs/PendenciesTab";
import { AnexosTab } from "@/components/tabs/AnexosTab";
...
const PatientDetails = () => {
  ...
  // Redirect para nova página se for novo paciente
  if (id === 'new') {
    return (
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-center text-muted-foreground py-8">
                Funcionalidade de cadastro de novo paciente em desenvolvimento.
              </p>
      ...
      <div className="max-w-7xl mx-auto p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-8">
            <TabsTrigger value="pendencias" className="relative flex items-center gap-2">
            ...
            <TabsTrigger value="cirurgia" className="flex items-center gap-2">
            ...
            <TabsTrigger value="extra-pacote" className="flex items-center gap-2">
          ...
          <TabsContent value="cirurgia">
            <SurgeryTab onAuditLog={addAuditLog} patient={patient} procedures={procedures} />
          </TabsContent>

          <TabsContent value="materiais">
            <MaterialsTab patient={patient} />
          </TabsContent>

          <TabsContent value="extra-pacote">
            <ExtraPackageTab patient={patient} />
          </TabsContent>

          <TabsContent value="faturamento">
            <BillingTab patient={patient} billing={billing} />
          </TabsContent>

          <TabsContent value="anexos">
            <AnexosTab patient={patient} />
          </TabsContent>

          <TabsContent value="auditoria">
            <AuditTab auditLogs={auditLogs} patient={patient} />
          </TabsContent>
        </Tabs>
      </div>
      <VirtualAssistant />
